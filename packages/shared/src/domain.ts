/**
 * Tipos de dominio de SysCreditos.
 * Mismo modelo que el sistema Firestore original (compat 1:1) para migración sin pérdida.
 * Los timestamps se mantienen como número (epoch ms) por compatibilidad con datos existentes.
 */
